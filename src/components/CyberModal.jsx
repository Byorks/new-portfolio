...
const CyberModal = ({
  ...
  return createPortal(
    ...
    >
      ...
      <div ref={modalRef} className="relative w-full max-w-7xl">
        {/* Lateral estilizada */}
          ...
          <div className="cyber-modal  bg-neutral-950 p-8">
            ...
            >
              {images.map((imgUrl, index) => (
                <div
                  key={index}
                  className="portfolio-item group relative aspect-video cursor-crosshair bg-cyber/10 p-[1px] clip-img"
                >
                  <div className="h-full w-full overflow-hidden bg-black clip-img">
                    <img
                      src={imgUrl}
                      alt={`Work ${index}`}
