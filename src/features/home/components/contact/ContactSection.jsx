        ...
        <div className="w-full mx-auto grid grid-cols-4 md:grid-cols-12 py-12 px-6 sm:px-8">
          <div className="col-span-6">
            ...
            <div className="py-4">
              ...
              <div className="flex">
                <CyberSquareButton link="https://github.com/Byorks" icon={githubIcon}></CyberSquareButton>
                <CyberSquareButton link="https://www.linkedin.com/in/vanessa-byork/" icon={SOCIAL_LOGOS[1]}></CyberSquareButton>
              </div>
            </div>
