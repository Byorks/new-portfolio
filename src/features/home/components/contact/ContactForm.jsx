  ...
  return (
    <div className="w-full">
      <form
        ...
        className="px-4 md:px-8 py-8  rounded border-border border-[0.5px] shadow-2xl bg-surface space-y-6"
      >
        {/* Campo nome */}
        <div className="">
          <label className="block text-xs font-bold tracking-wider mb-1">
            Nome
          </label>
          <input
            {...register("name")}
        ...
        <div className="flex flex-col gap-1.5">
            ...
            className={`w-full px-4 py-3 rounded border placeholder:text-midnightviolet-500/80 bg-midnightviolet-950-main focus:bg-slate-950 transition-all ease-in-out duration-300 outline-none resize-none autofill-fix
                ${
                  errors.message
                    ...
                    : "border-midnightviolet-500  focus:border-primary focus:ring-1 focus:ring-primary"
                }`}
          />
          ...
          <div className="flex justify-between items-start mt-1 px-1">
            {errors.message ? (
              ...
              <p className="text-xs">
                Evite compartilhar senhas ou dados sensíveis.
              </p>
            )}
        ...
        <button
          ...
          className="w-full bg-background hover:bg-secondary border-border py-2 font-bold border text-primary hover:text-neutral-100 transition-all transform active:scale-[.98] flex justify-center items-center cursor-pointer"
        >
          {isSubmitting ? (
            <svg
